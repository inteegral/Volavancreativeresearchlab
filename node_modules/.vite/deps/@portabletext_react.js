...
function buildMarksTree(block) {
  ...
  for (let i = 0; i < children.length; i++) {
    ...
    if (nodeStack.length > 1) for (; pos < nodeStack.length; pos++) {
      let mark = ((_a = nodeStack[pos]) == null ? void 0 : _a.markKey) || "", index = marksNeeded.indexOf(mark);
      if (index === -1) break;

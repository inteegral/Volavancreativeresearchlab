  ...
  return (
    <div className="pt-24 pb-12 px-6 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-16">
        <span className="text-volavan-aqua text-xs uppercase tracking-[0.2em] mb-4 block">Partecipa</span>
        <h1 className="text-4xl md:text-5xl font-light text-volavan-cream">Candidature Aperte</h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
        ...
        {activeCall ? (
          <div>
            <div className="bg-volavan-cream p-8 mb-8 border-l-4 border-volavan-aqua">
            ...
            <h4 className="text-lg font-light text-volavan-cream mb-4 uppercase tracking-wide">Requisiti</h4>
            <ul className="list-disc pl-5 space-y-2 text-volavan-cream/80 mb-8 marker:text-volavan-aqua">
           ...
           <div className="bg-volavan-cream/10 p-8 text-center text-volavan-cream col-span-2 border border-volavan-cream/20">
            ...
            <div className="space-y-6">
              <div>
                ...
                <input 
                  ...
                  className="w-full border border-gray-300 px-4 py-3 focus:outline-none focus:border-volavan-earth transition-colors bg-gray-50 text-[#333]"
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                type="submit" 
                className="w-full bg-volavan-earth text-white py-4 uppercase tracking-widest text-xs hover:bg-volavan-earth-deeper transition-colors font-semibold"
